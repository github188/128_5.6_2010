...
namespace CustomUIControls
{
    ...
    public class TaskbarNotifier : System.Windows.Forms.Form
    {
        ...
        //Czlt-2011-12-10 判断窗体是不是已经弹出
        public bool IsOpen = false;

        //Czlt-2011-12-10 隐藏事件
        public event EventHandler CzltEvent = null;


        #endregion

        #region 【Czlt-2011-12-09 枚举】
        /// <summary>
